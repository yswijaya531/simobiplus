...
SET SIMOBI_TOKEN_URL=/labs/sb/oauthdev/oauth2/token
SET SIMOBI_PUSH_INVOICE_URL=/labs/sb/pushinvoice/push-invoice
SET SIMOBI_PUSH_STATUS_URL=/simobi
SET SIMOBI_PUSH_INVOICE_URL=/labs/sb/pushinvoice/push-invoice
SET SIMOBI_PUSH_STATUS_URL=/simobi
SET SIMOBI_PULL_STATUS_URL=/simobi
SET SIMOBI_REFUND_URL=/labs/sb/pushinvoice/refund-invoice 
